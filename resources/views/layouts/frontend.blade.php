...
<head>
  ...
  <link href="{{ asset("assets/frontend")}}/css/slitslider.css" rel="stylesheet" />
  <link href="{{ asset("assets/frontend")}}/css/style.css" rel="stylesheet" />
  <!-- Theme skin -->
  <link id="t-colors" href="{{ asset("assets/frontend")}}/skins/blue.css" rel="stylesheet" />
  <!-- boxed bg -->
      ...
      <div class="container">
        ...
        <div class="row nomargin">
          <div class="span12">
            <div class="headnav">
              <ul>
                <li> <router-link to='/login'><a>Sign up</a></router-link> </li>
                <li><a>Sign in</a></li>
              </ul>
            </div>
          </div>
